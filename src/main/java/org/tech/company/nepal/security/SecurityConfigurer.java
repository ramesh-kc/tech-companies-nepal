package org.tech.company.nepal.security;
...
import org.tech.company.nepal.filter.JwtRequestFilter;
...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
  ...
  public SecurityConfigurer(CompanyUserDetailService companyUserDetailService, JwtRequestFilter jwtRequestFilter) {
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    auth.userDetailsService(companyUserDetailService);
  }
